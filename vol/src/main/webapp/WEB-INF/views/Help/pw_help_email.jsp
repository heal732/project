...
<input type="hidden" id="hide_id" value="${id }"/>
...
<div id="id_s_total">
	<div id="id_s_pw">
		...
		<div style="width:100%; height:60px; margin-top:60px;">
			<div style="float:left; margin-top: 10px; margin-left: 5%; ">이메일: 
			</div>
			<div id="num_div"><input type="text" name="s_email" id="s_email"/><br/><br/>
			</div><br/>
		</div>
		<div style="margin-top: 80px; width:100%; height:60px;">
			<div style="width:40%; height:40px; margin:0px auto;">
				<button type="button" class="btn_s" onclick="pw_search_go()">찾기</button>
			</div>
		</div>
	</div>
</div>
